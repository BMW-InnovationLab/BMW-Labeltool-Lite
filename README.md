...
- Go to training-data/**yourdatasetsfolder** inside the labeling project's repository , copy the folder "images" and paste it inside your newly created folder "mydataset" in your 
