...
DEFAULT_DATA_DIR: str = os.path.join('data', 'training-data')
...
datasetfolder = os.path.join(os.getcwd(), DEFAULT_DATA_DIR, args.dir)
print(f"Getting data from {datasetfolder}")
