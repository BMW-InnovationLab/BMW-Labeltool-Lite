...
namespace Robotron.Imagine
{
    ...
    public class ImageTransformationPipeline
    {
        ...
        /// </summary>
        /// <param name="transformationParameters">Parameters to use during transformation process</param>
        /// <param name="transformations">Transformation operations to use</param>
        ...
        /// <returns>Stream with transformed image</returns>
