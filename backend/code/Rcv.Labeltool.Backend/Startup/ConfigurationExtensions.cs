...
namespace Rcv.LabelTool.Backend
{
    ...
    public static class ConfigurationExtensions
    {
        ...
        /// <summary>
        /// Name of OnPremise configuration section.
        /// </summary>
        private const string OnPremiseConfigurationSection = "OnPremise";
        ...
        {
            return configuration.GetConfiguration<OnPremiseConfiguration>(OnPremiseConfigurationSection);
        }

        /// <summary>
        /// Get configuration for segmentation webservice.
        /// </summary>
        /// <param name="configuration">Appsettings configuration</param>
        /// <returns>Configuration of segmentation webapi</returns>
        public static InferenceConfiguration GetSegmentationConfiguration(this IConfiguration configuration)
        {
            return configuration.GetConfiguration<InferenceConfiguration>("Inference");
        }
